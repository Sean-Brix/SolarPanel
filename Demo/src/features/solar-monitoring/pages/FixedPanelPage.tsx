...
import { fixedReadings, getAllReadingsSince } from '@/features/solar-monitoring/data/panel-readings-source'
...
function fetchAllFixedReadings(range: TimeRange) {
  const since = rangeToSinceDate(range)
  return getAllReadingsSince(fixedReadings, since)
}
