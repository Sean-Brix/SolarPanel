...
import { getAllAnnRunsForExport } from '@/features/solar-monitoring/data/ann-source'
...
function timeFilterToIso(timeFilter: AnnDashboardTimeFilter) {
...
function fetchAllAnnRuns(
  range: AnnRange,
  filters: AnnDashboardFilters,
  timeFilter: AnnDashboardTimeFilter,
): AnnRunSummary[] {
  const { startAt, endAt } = timeFilterToIso(timeFilter)
  return getAllAnnRunsForExport(range, filters, startAt, endAt)
}
