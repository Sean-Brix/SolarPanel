  ...
  return (
    <div className="space-y-4 pb-10">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-5">
        ...
        <MetricCard icon={SunMedium} label="Energy today" value={panel.metrics.energyToday} note="Accumulated since sunrise" format="energy" />
        <MetricCard icon={LineChart} label="Efficiency" value={panel.metrics.efficiency} note="Reference efficiency score" tone="rose" format="percent" />
      </div>
      ...
      <div className="grid gap-4 lg:grid-cols-[1.15fr_0.85fr]">
        <ChartCard
          ...
          data={getPanelRangeEnergy('fixed', range)}
          series={[
        ...
        <div className="grid gap-4">
          <MetricCard icon={SunMedium} label="Peak power" value={panel.metrics.peakPower} note="Best observed output in the current sample set" tone="amber" format="power" />
      ...
      <HistoricalLogTable
        ...
        description="Reference measurements over time."
      />
    </div>
  )
}
